...
class CongresspersonImport: 
    ...
    def get_name(self, num=0):
        if self._data == "":
            self.conduct_call()
        losangeles = self.get_data()
        losangeles1 = json.dumps(losangeles)
        losangeles2 = json.loads(losangeles1)
        return losangeles2['results'][num]['name']
    ...
    def get_twitter(self, num=0):
        ...
        losangeles1 = json.dumps(losangeles)
        losangeles2 = json.loads(losangeles1)
        return losangeles2['results'][num]['twitter_id']
    ...
    def get_dist(self, num=0):
        ...
        losangeles1 = json.dumps(losangeles)
        losangeles2 = json.loads(losangeles1)
        return losangeles2['results'][num]['district'] + "th District"
    ...
    def get_party(self, num=0):
        ...
        losangeles1 = json.dumps(losangeles)
        losangeles2 = json.loads(losangeles1)
        return losangeles2['results'][num]['party']
